...
--intercept-h2 1.0439,1.0253,0.9897,1.0187,1.0696,1.0191,1.0214,1.0269,1.0061,0.9918,0.9945,1.0087 \
--intercept-gencov 0,0,0,0,-0.0157,0,0,0,0,0,0,0 \
--out pgc_diff_int_rgs_constrained_new